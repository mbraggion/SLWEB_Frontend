			...
			<DialogContent>
				<div className='YAlign'>
					{props.UltChamado !== null ? (
						...
						>
							<strong>
								Último chamado aberto em{' '}
								{moment(props.UltChamado).format('DD/MM/YYYY')}
							</strong>
						</Typography>
					) : null}
					<Typography
					...
					>
						<TextField
							...
							variant='outlined'
							onChange={(value) =>
								props.onChangeDetails((oldState) => {
						...
						<TextField
							...
							onChange={(value) =>
								props.onChangeDetails((oldState) => {
									return {
										...oldState,
										Endereco: { ...oldState.Endereco, Logradouro: value },
									};
								})
							}
						/>
						...
						<TextField
							...
							onChange={(value) =>
								props.onChangeDetails((oldState) => {
									return {
										...oldState,
										Endereco: { ...oldState.Endereco, Numero: value },
									};
								})
							}
						/>
						<TextField
							...
							onChange={(value) =>
								props.onChangeDetails((oldState) => {
									return {
										...oldState,
										Endereco: { ...oldState.Endereco, Bairro: value },
									};
								})
							}
						/>
						...
						<TextField
							...
							onChange={(value) =>
								props.onChangeDetails((oldState) => {
									return {
										...oldState,
										Endereco: { ...oldState.Endereco, Complemento: value },
									};
								})
							}
						/>
						<TextField
							...
							onChange={(value) =>
								props.onChangeDetails((oldState) => {
									return {
										...oldState,
										Endereco: { ...oldState.Endereco, Cidade: value },
									};
								})
							}
						/>
						...
						<TextField
							...
							onChange={(value) =>
								props.onChangeDetails((oldState) => {
									return {
										...oldState,
										Endereco: { ...oldState.Endereco, UF: value },
									};
								})
							}
						/>
						<TextField
							...
							onChange={(value) =>
								props.onChangeDetails((oldState) => {
									return {
										...oldState,
										Endereco: { ...oldState.Endereco, CEP: value },
									};
								})
							}
						/>
