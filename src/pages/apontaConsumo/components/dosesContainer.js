...
export const DosesList = () => {
	...
	const {
		data: { Detalhes, Zerada },
		actions: { onOpenReceitaModal },
	} = useConsumo();
								...
								<tr>
									...
									<td className={classes.cell}>
										<label
											...
											onClick={() => onOpenReceitaModal(d.RecId)}
										>
											"{d.RecDesc}"
										</label>
									</td>
									<td className={classes.cell}>{Zerada ? 0 : d.QtdI}</td>
									<td className={classes.cell}>{d.QtdF}</td>
									<Tooltip
										title={
											<div
												style={{
									...
									>
										<td
											...
											style={{ color: RED_PRIMARY, fontWeight: 'bold' }}
										>
											{Zerada ? d.QtdF : d.QtdF - d.QtdI}
										</td>
									</Tooltip>
									<td className={classes.cell}>{Zerada ? 0 : d.TstI}</td>
									<td className={classes.cell}>{d.TstF}</td>
									<Tooltip
										title={
											<div
												style={{
