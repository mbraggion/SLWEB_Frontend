			...
			<DialogContent dividers>
				<div className={classes.root}>
					<Typography gutterBottom variant='body1'>
						{jaLancouInventario
							? 'Uma movimentação deste despósito dentro deste período já foi feita.'
							: 'A movimentação dos insumos abaixo será lançada em inventário.'}
					</Typography>
					...
					<Typography variant='subtitle1'>
						Referencia:{' '}
						<strong>
							{moment(selectedRef).add(3, 'hours').format('MM/YYYY')}
						</strong>
					</Typography>
					<Typography variant='subtitle1'>
						Período:{' '}
						<strong>
							{selectedL1 !== null
								? moment(
										leituras.filter((l) => l.LeituraId === selectedL1)[0]
											.DataLeitura
						...
						<strong>
							{selectedL2 !== null
								? moment(
										leituras.filter((l) => l.LeituraId === selectedL2)[0]
											.DataLeitura
								  ).format('DD/MM/YYYY hh:mm:ss')
								: null}
						</strong>
					...
					{!jaLancouInventario ? (
						<ConsumoALancar Consumo={Consumo} Zerada={Zerada} />
					) : null}
								...
								<div className='YAlign'>
									{ConsumoJaLancado.length > 0 ? (
										...
										<Typography variant='h6'>
											Nenhum lançamento de consumo anterior gravado.
										</Typography>
									)}
								</div>
							</AccordionDetails>
