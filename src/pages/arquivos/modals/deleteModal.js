		...
		>
			...
			<DialogContent dividers>
				...
				<Typography variant='caption'>
					*{markedItems.length > 0 ? 'O arquivo' : 'A pasta'} será{' '}
					{markedItems.length > 0 ? 'movido' : 'movida'} para lixeira e apenas
					um administrador poderá recupera-
					{markedItems.length > 0 ? 'lo' : 'la'}.
				</Typography>
			</DialogContent>
