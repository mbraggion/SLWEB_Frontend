				...
				<FormControl variant='outlined' className={classes.formControl}>
					...
					>
						...
						{leiturasDisponiveis
							.filter((ld) => {
								if (
									margemSelecionada.ate === null ||
									ld.PedidoId < margemSelecionada.ate
								) {
									return true;
								} else {
									return false;
							...
							.map((leitura) => (
								<MenuItem key={leitura.PedidoId} value={leitura.PedidoId}>
				...
				<FormControl variant='outlined' className={classes.formControl}>
					...
					>
						...
						{leiturasDisponiveis
							.filter((ld) => {
								if (
									margemSelecionada.de === null ||
									ld.PedidoId > margemSelecionada.de
								) {
									return true;
								} else {
									return false;
