...
export const ContractListItem = ({ contract, onOpenModal }) => {
	const classes = useStyles({
		...
		background: 'unset',
		border:
			contract.ConStatus === 'A'
				? `1px solid ${RED_PRIMARY}`
				: `1px solid ${GREY_SECONDARY}`,
	});

	return (
		<div className={classes.box} onClick={() => onOpenModal(contract)}>
			...
			<div className={classes.infoContainer}>
				...
				<Typography variant='body2' style={{ textAlign: 'right' }}>
					Cadastro:{' '}
					{contract.Dt_Inicio !== null
						? moment(contract.Dt_Inicio).format('DD/MM/YYYY')
						: 'Desconhecido'}
				</Typography>
