...
import { Button, IconButton, FormControlLabel, Tooltip, Checkbox, Dialog, DialogActions, DialogContent, DialogTitle, Paper, Typography } from '@material-ui/core';
import { Toast } from '../../../components/toasty'
import { Link as LinkIcon, Refresh as RefreshIcon, Delete as DeleteIcon } from '@material-ui/icons'
        ...
        <DialogContent>
          <div className={classes.outerContainer}>
            <div className={classes.container}>
              <Typography gutterBottom variant="button">Matrícula da máquina</Typography>
              {loadingAtiv
                ? (
                  <>
            ...
            <div className={classes.container} style={{ height: '330px' }}>
              <Typography gutterBottom variant="button">Link para auditoria</Typography>
              {loadingAudit
                ? (
                  <>
                    <Typography align="center">Aguarde...</Typography>
                ...
                : linkAudit.id !== null
                        ...
                        <FormControlLabel
                          ...
                          control={
                            <Checkbox
                              ...
                              onChange={() => handleUpdateLink(linkAudit.id, 'compartilhamento', linkAudit.status)}
                  ...
                  : (
                    <>
                      ...
                      <Typography variant='caption'><strong>Link ainda não criado!</strong></Typography>
                    </>
                  )
              }
            </div>
