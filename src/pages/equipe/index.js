					...
					>
						...
						>
							<IconButton
								onClick={() =>
									window
										.open('http://facebook.com/pilaoprofessional', '_blank')
										.focus()
								}
								style={{ color: '#4267B2' }}
								aria-label='Facebook'
						...
						>
							<IconButton
								onClick={() =>
									window
										.open('http://instagram.com/pilaoprofessional_', '_blank')
										.focus()
								}
								style={{ color: '#E1306C' }}
						...
						>
							<IconButton
								onClick={() =>
									window
										.open(
											'http://linkedin.com/company/pil%C3%A3o-professional',
											'_blank'
										)
										.focus()
								}
						...
						>
							<IconButton
								onClick={() =>
									window
										.open(
											'http://youtube.com/channel/UCZLxQndAv06x6nCL0PLThZQ',
											'_blank'
										)
										.focus()
								}
