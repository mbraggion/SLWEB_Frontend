...
import { LinearProgress, Typography, useMediaQuery, useTheme } from "@material-ui/core";
import { CheckCircle as CheckCircleIcon, SyncDisabled as SyncDisabledIcon } from '@material-ui/icons';
import { CircularStatic } from './components/progressCircle';

export const FormHelper = ({ loading, question, sectionLength, submitError, formFinished }) => {
  ...
  return (
    ...
    >
      ...
      >
        {whichHelperDisplay(loading, question, sectionLength, submitError, fullScreen, formFinished)}
      </div>
    </div>
  )
}

const whichHelperDisplay = (loading, question, sectionLength, submitError, fullScreen, formFinished) => {
