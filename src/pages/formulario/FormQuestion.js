	...
	if (loading) {
		...
		return (
			<QuestionBox
				...
				onRetreat={() =>
					Toast('Não é possivel navegar de volta a um formulário já preenchido')
				}
			/>
		);
	}
			...
			return (
				...
				>
					...
					<NewFileInput
						...
						onChange={() =>
							setFilenames(getFileNames(makeFormData(getFiles())))
						}
