...
export const FormStepper = ({ stepsName, section, formFinished }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Stepper
          activeStep={whichStepIsActive(fullScreen, section, stepsName, formFinished)}
          orientation="vertical"
          style={{
            background: "transparent",
          }}
        >
          {whichStepDisplay(fullScreen, stepsName, section, formFinished, classes)}
        </Stepper>
      </div>
    </div>
  )
...
const whichStepDisplay = (fullScreen, stepsName, section, formFinished, classes) => {
  if (formFinished) {
    return <Step>
      <StepLabel
