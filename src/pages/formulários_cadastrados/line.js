		...
		>
			<div className={classes.formInfoContainer}>
				<div className={classes.infoLine1}>
					<Typography>
						<strong>Solicitante:</strong> {Form.Email}
					</Typography>
					<Typography>
						<strong>Fomulário:</strong> {Form.FormName}
					</Typography>
				</div>

				<div className={classes.infoLine2}>
					<Typography className={classes.secondLineText}>
						<strong>Código:</strong> {Form.Cod} |
					</Typography>
					<Typography className={classes.secondLineText}>
						<strong>Status:</strong>{' '}
						{Form.FormOpen ? 'Em Andamento' : 'Finalizado'} |
					</Typography>
					<Typography className={classes.secondLineText}>
						<strong>{Form.FormOpen ? 'Solicitado' : 'Finalizado'}:</strong>{' '}
						{Form.FormOpen
							? moment(Form.FormDtRequest).format('L')
							: moment(Form.FormDtFulfilled).format('L')}
					</Typography>
				</div>
			</div>
