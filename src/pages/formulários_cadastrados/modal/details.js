                ...
                return (
                  ...
                  <div style={divMetade}>
                    ...
                    {Form.Questions[s].map(q => {
                      if (q.QuestionAnswer !== null && q.QuestionAnswer !== '') {
                        return (
                          <div style={divLinha}>
                            <Typography gutterBottom>
                              {q.QuestionSlug}: <strong style={{ color: 'red' }}>{q.QuestionType === 'date' ? moment(q.QuestionAnswer).format('L') : q.QuestionAnswer}</strong>
                            </Typography>
                          </div>
                        )
                      } else {
