			...
			<div className={classes.left}>
				<div className={classes.PerfilBase}>
					<div className={classes.Avatar}>
						<img src={AnnonProfileIcon} alt='logo' />
					...
					<div className={classes.Dados}>
						...
						<div className={classes.information}>
							...
							<div className={classes.infoContainer}>
								...
								<p className={classes.Relevant}>
									{vencCert === null || vencCert === 'Desconhecido'
										? 'Não'
										: 'Sim'}
								</p>
							</div>
							...
							<div className={classes.infoContainer}>
								...
								<p className={classes.Relevant}>------</p>
							</div>
						</div>
					</div>
				</div>
						...
						<div className={classes.infoContactR}>
							...
							>
								<InputUnderline
									...
									disabled={wait}
									type='text'
									label={`Atual: ${toValidString(info.Email)}`
										.split(';')[0]
										.concat('...')}
							...
							>
								<div>
									...
									<InputNumber
										...
										onChange={(e) =>
											setNewTaxa({ ...newTaxa, valor: e.target.value })
										}
										label={
											newTaxa.tipo === 'PERCENTUAL'
												? 'Porcentagem(%)'
												: 'Valor(R$)'
										}
										disabled={false}
